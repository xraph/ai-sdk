...
func (b *EnhancedAgentBuilder) WithLogger(logger logger.Logger) *EnhancedAgentBuilder {
...
func (b *EnhancedAgentBuilder) WithMetrics(metrics metrics.Metrics) *EnhancedAgentBuilder {
