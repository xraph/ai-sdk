...
func TestAgent_GetState(t *testing.T) {
	...
	_ = agent.SetStateData("test", "data")
...
func TestAgent_SaveState(t *testing.T) {
	...
	_ = agent.SetStateData("key", "value")
...
func TestAgent_ClearHistory(t *testing.T) {
	...
	// Add some messages
	_ = agent.addToHistory(AgentMessage{Role: "user", Content: "Hello"})
	_ = agent.addToHistory(AgentMessage{Role: "assistant", Content: "Hi there"})
...
func TestAgent_MarshalUnmarshalState(t *testing.T) {
	...
	_ = agent.SetStateData("key", "value")
	_ = agent.addToHistory(AgentMessage{Role: "user", Content: "Test"})
...
func TestAgent_GetHistoryLength(t *testing.T) {
	...
	_ = agent.addToHistory(AgentMessage{Role: "user", Content: "Hello"})
	_ = agent.addToHistory(AgentMessage{Role: "assistant", Content: "Hi"})
...
func TestAgent_Callbacks(t *testing.T) {
	...
	if agent.callbacks.OnStart != nil {
		_ = agent.callbacks.OnStart(context.Background())
	}
