...
// ToolInvocation represents a tool call made by the LLM.
// Renamed from ToolCall for clarity.
...
// ToolCall is an alias for ToolInvocation for backward compatibility.
// Deprecated: Use ToolInvocation instead.
