...
func NewUIToolRegistry(logger logger.Logger, metrics metrics.Metrics) *UIToolRegistry {
...
func (r *UIToolRegistry) ExecuteUITool(
	...
	onEvent func(llm.ClientStreamEvent) error, logger logger.Logger, metrics metrics.Metrics,
	executionID string,
