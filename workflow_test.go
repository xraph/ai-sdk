...
func TestWorkflow_AddEdge_Cycle(t *testing.T) {
	...
	_ = wf.AddEdge("node1", "node2")
	_ = wf.AddEdge("node2", "node3")
...
func TestWorkflow_Execute_Parallel(t *testing.T) {
	...
	_ = wf.AddNode(start)
	_ = wf.AddNode(parallel1)
	_ = wf.AddNode(parallel2)
	_ = wf.AddEdge("start", "parallel1")
	_ = wf.AddEdge("start", "parallel2")
